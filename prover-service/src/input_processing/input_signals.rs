...
pub fn derive_circuit_input_signals(
    ...
    let mut circuit_input_signals = CircuitInputSignals::new()
        ...
        .u64_input("exp_delta", verified_input.exp_horizon_secs)
        .frs_input("temp_pubkey", &ephemeral_pubkey_frs)
        .fr_input("temp_pubkey_len", ephemeral_pubkey_len)
        .fr_input("jwt_randomness", verified_input.epk_blinder_fr)
